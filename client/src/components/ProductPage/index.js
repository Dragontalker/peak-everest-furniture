      ...
      <div className="card mb-3 card-background">
        <div className="row g-0">
          <div className="col-md-6">
            ...
            <img className="productPage-img" src="https://i.gyazo.com/97b764beb0a96af871fec590c7e217c3.png" alt="product" />
          </div>
          <div className="col-md-6">
            <div className="card-body">
              ...
              <br/>
              <button className="btn btn-primary product-button">Add to Cart</button>
            </div>
          </div>
        </div>
      </div>
